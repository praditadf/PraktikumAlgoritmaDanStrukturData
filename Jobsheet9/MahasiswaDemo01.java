...
public class MahasiswaDemo01 {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("6. Total Tugas Dikumpulkan");
            ...
            switch (pilih) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Mahasiswa01 lihatBawah = stack.tugasBawah();
                    if (lihatBawah != null) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    int totalTugas = stack.hitungTugas() +1 ;
                    System.out.println("Total tugas yang sudah terkumpul saat ini " +totalTugas);
                    break;
                default:
